...
public class MainReadAdData {
    ...
    public static class DataBean   implements Parcelable {
        ...
        public DataBean(String id, String title, String cover, String bottom_text, String bgcolor, String pv_url) {
            this.id = id;
            this.title = title;
            this.cover = cover;
        ...
        public static final Creator<DataBean> CREATOR = new Creator<DataBean>() {
            ...
            public DataBean createFromParcel(Parcel in) {
                ...
                String bottom_text = in.readString();
                String bgcolor = in.readString();
                String pv_url = in.readString();
                return new DataBean(id,title,cover,bottom_text,bgcolor,pv_url);
            }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(bottom_text);
            dest.writeString(bgcolor);
            dest.writeString(pv_url);
        }
    }
}
