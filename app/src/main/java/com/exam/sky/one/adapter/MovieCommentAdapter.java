...
public class MovieCommentAdapter extends BaseAdapter {
    List<MovieCommentDetail.DataBean.DataBeans> beanList;
    Context context;
    int type;

    public MovieCommentAdapter(List<MovieCommentDetail.DataBean.DataBeans> data, Context context) {
        this.beanList = data;
    ...
    @Override
    public MovieCommentDetail.DataBean.DataBeans getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MovieCommentDetail.DataBean.DataBeans dataBeans =  beanList.get(position);
